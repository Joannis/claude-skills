...
description: 'Expert guidance on Swift library and framework design. Use when developers mention: (1) designing a Swift library or framework, (2) API design patterns, (3) protocol-oriented architecture, (4) result builders, (5) performance optimization for libraries, (6) @inlinable/@usableFromInline, (7) noncopyable types for APIs.'
---
